...
3. All layout, ordering, interaction, and no-JS behaviour per UX.md §2–3. All visual decisions per DESIGN.md — including the field-notation amenity system (DESIGN.md §6), which is a build requirement, not a suggestion.
